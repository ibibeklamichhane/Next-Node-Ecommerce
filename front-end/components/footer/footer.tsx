...
const Footer: React.FC = () => {
  return ( 
    <footer className="bg-white dark:bg-[#030406] mt-20">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <p className="hover:underline">Kathmandu, Nepal, <br/> DH 1515, Nepal.</p>
                </li>
                <li>
                  <a  className="hover:underline">viveklc99@gmail.com</a>
                </li>
                <li>
                  <a  className="hover:underline">9876543210</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            © 2024 <a href="#" className="hover:underline">Bibek Lamichhane™</a>. All Rights Reserved.
          </span>
